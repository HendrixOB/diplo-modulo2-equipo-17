...
def traducir_texto(text, target_lang):
    ...
    partes_traducidas = []
    for parte in partes:
        traducido = traductor.translate(parte, dest=target_lang).text
...
traducido_coreano = traducir_texto(r.texto_coreano, 'en')
traducido_texto_japones_h = traducir_texto(r.texto_japones_h, 'en')
traducido_texto_japones_k = traducir_texto(r.texto_japones_k, 'en')
traducido_chino = traducir_texto(r.texto_chino, 'en')
```
